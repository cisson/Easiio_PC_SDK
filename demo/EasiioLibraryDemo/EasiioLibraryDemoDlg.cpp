...
CEasiioLibraryDemoDlg::~CEasiioLibraryDemoDlg() {
...
BOOL CEasiioLibraryDemoDlg::OnInitDialog()
{
	...
	EasiioInitDeveloperKeyAndToken("04ed2ff8e149eaa647s415aicbaa6e5e946a", "CefgvsgcpM"); //cisson test  
...
void CEasiioLibraryDemoDlg::OnBnClickedCall()
{
	...
	CallManagerDlg mCallManagerDlg(this, str);
	mCallManagerDlg.DoModal();
}
